...
const Servicios = () => {
  ...
  const consultarServicio = (titulo) => {
    const numero = "51933698990"; 
    const mensaje = `¡Hola Dra. Karen! Vengo de su página web y deseo más información sobre el servicio de: ${titulo}.`;
          ...
          {listaServicios.map((servicio, index) => (
            ...
            >
              ...
              <div className="p-8 flex flex-col flex-grow text-center">
                ...
                {/* Botón con función de consulta vinculada al título */}
                <button 
                  onClick={() => consultarServicio(servicio.titulo)}
                  className="mt-8 text-[10px] font-bold tracking-[0.2em] text-[#7c8f7c] uppercase border border-[#7c8f7c] rounded-full py-3 px-6 hover:bg-[#7c8f7c] hover:text-white transition-all transform hover:-translate-y-1 self-center"
                >
                  Consultar
                </button>
              </div>
